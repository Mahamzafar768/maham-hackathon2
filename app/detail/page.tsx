        ...
        <div className="w-full h-auto flex md:flex-row flex-col gap-6 md:px-12 lg:px-[150px]">
            ...
            <div className="w-full md:w-[80%]  bg-[#F6F7F9]  p-6">
                <div className='flex md:flex-row flex-col gap-4'>
                    ...
                    <div className="w-full md:w-[73%] h-auto shadow-sm bg-white shadow-gray p-6 md:p-8">
                        ...
                        <div className="flex flex-wrap justify-between items-center gap-6 mt-8">
                            ...
                            <div>
                                <button className="bg-[#3563E9] text-white px-6 py-3 md:px-8 md:py-4 rounded-md" onClick={handleRoute}>
                                    Rent Now
                                </button>
                            </div>
                        </div>
                ...
                <div className='mt-10 bg-white w-full h-auto  rounded-lg p-4'>
                    ...
                    <div className="w-full bg-white flex flex-wrap gap-6 justify-center ">
                        <div className="w-full sm:w-[100%] md:w-[45%] lg:w-[30%] mt-10 shadow-md rounded-lg overflow-hidden border">
                            <div className="p-4">
                                {/* Header */}
